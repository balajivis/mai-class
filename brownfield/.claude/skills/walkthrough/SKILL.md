...
1. Read `sprints/$ARGUMENTS/prd.md` for sprint goals and acceptance criteria
2. Read `sprints/$ARGUMENTS/tasks.md` for task list and completion status
...
6. Check `./sprints/$ARGUMENTS/screenshots/` for visual evidence

## Output

Write to `./sprints/$ARGUMENTS/review.md` using the format in `templates/review.md`.
