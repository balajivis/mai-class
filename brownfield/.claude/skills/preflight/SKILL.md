---
name: preflight
description: "Pre-sprint health check — git status, build, arch drift, infra, UX audit. Run before /prd for a go/no-go verdict."
argument-hint: "[sprint e.g. v5]"
allowed-tools: Read, Grep, Glob, Write, Bash, Task
---

You are running a pre-sprint health check.

**Sprint**: $ARGUMENTS
**Output**: `./sprints/$ARGUMENTS/preflight.md`
...
preflight $ARGUMENTS complete:
  ...
  Report: sprints/$ARGUMENTS/preflight.md
```
...
| Infra health checks fail | ⚠️ Caution — investigate before proceeding |
