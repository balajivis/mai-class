...
2. Read `PRINCIPLES.md` — these constraints apply to everything you build
3. Read the specific task from `sprints/{version}/tasks.md` or the task description passed to you
...
**Complete a meaningful chunk?** Write a detailed entry file to `entries/`:
```
...
**Discover follow-on work?** Add to `backlog.md` under `## Inbox`:
```
