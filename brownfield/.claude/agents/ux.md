...
2. Read `PRINCIPLES.md` — understand product constraints
...
For the full audit, write a single entry file to `entries/`:
```
...
**Discover gaps needing follow-on work?** Add to `backlog.md` under `## Inbox`.
