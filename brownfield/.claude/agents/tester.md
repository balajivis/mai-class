...
2. Read `PRINCIPLES.md` — tests are documentation: every test is a contract
...
**Discover untested paths that need separate tasks?** Add to `backlog.md` under `## Inbox`.

For significant test runs, write an entry file to `entries/`:
```
